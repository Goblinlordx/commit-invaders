...
function makeConfig(overrides: Partial<SimConfig> = {}): SimConfig {
  return {
    ...
    waveConfig: { weeksPerWave: 4, startDelay: 0, spawnDelay: 10, brightenDuration: 0, pluckDuration: 0, darkenDuration: 0, travelDuration: 0, hatchDuration: 0, endingFadeoutDuration: 0, endingScoreDuration: 0, endingHoldDuration: 0, endingBlackoutDuration: 0, endingResetDuration: 0 },
